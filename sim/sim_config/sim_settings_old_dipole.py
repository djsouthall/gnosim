{'outfile_dir'          :   '/home/dsouthall/scratch-midway2/April9/', #Where the data files will be saved.  Should end in /
'outfile_name_root'     :   'results_2019_April', #This will be the first part of the outfiles name.  It will be followed by information about the simulation such as station_config_file_name and the number of neutrino events.
'station_config_file'   :   '/home/dsouthall/Projects/GNOSim/gnosim/detector/station_config/real_config_antarctica_180_rays_signed_fresnel_old_dipole.py', #The address of the station configuration file
...
'electricFieldDomain'   :   'time', #Enables a the performance of beamforming trigger on digitized signals.  Meta data will be stored in the info section of the outfile pertaining to this.  Beams will only be triggered on if trigger_threshold_units is 'fpga'. 
