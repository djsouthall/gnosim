{'outfile_dir'          :   '${GNOSIM_DATA}/', #Where the data files will be saved.  Should end in /
'outfile_name_root'     :   'results_2019_testing_input_event_locations', #This will be the first part of the outfiles name.  It will be followed by information about the simulation such as station_config_file_name and the number of neutrino events.
'station_config_file'   :   '${GNOSIM_DIR}/gnosim/detector/station_config/real_config_antarctica_180_rays_signed_fresnel.py', #The address of the station configuration file
'solutions'             :   ['direct'],#The solutions to work with in the simulation #['direct', 'cross', 'reflect', 'direct_2', 'cross_2', 'reflect_2']
'image_extension'       :   'svg',  #The file type for any saved images.
'image_path_root'       :   '${GNOSIM_FIGURES}/', #The location of the directory for which a new subfolder with the name of the simulation will be created for output images.
...
'trigger_threshold'     :   0,  #The threshold, with units specified below.  
