...
'outfile_name_root'     :   'results', #This will be the first part of the outfiles name.  It will be followed by information about the simulation such as station_config_file_name and the number of neutrino events.
'station_config_file'   :   '${GNOSIM_DIR}/gnosim/detector/station_config/ara5_full_station_antarctica_allison.py', #The address of the station configuration file
