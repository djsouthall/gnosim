...
class Sim:
    ...
    def detector(self):
        ...
        for key in self.config['antenna_definitions'].keys():
            self.lib[key] = gnosim.trace.refraction_library.RefractionLibrary(self.config['antenna_definitions'][key]['lib'],pre_split = self.pre_split)
...
if __name__ == "__main__":
    ...
    #python /home/dsouthall/Projects/GNOSim/sim/sim.py config energy n_events index 
    #python /home/dsouthall/Projects/GNOSim/gnosim/sim/sim.py /home/dsouthall/Projects/GNOSim/gnosim/sim/ConfigFiles/Config_dsouthall/config_octo_-200_arthern_120_rays.py 1.0e8 50000 1 
    #f.close()
