...
def electricField(frequency, d, angle, energy_neutrino, inelasticity, mode, index_of_refraction):
    """
...
if __name__ == "__main__":
    ...
    electric_field = electricField(frequency_mesh, d, angle_mesh, energy_neutrino, inelasticity, mode, index_of_refraction)
    pylab.figure()
