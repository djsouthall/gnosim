...
def electricFieldTimeDomainSignal(theta_obs_rad,R,Energy_GeV,n,h_fft=None,sys_fft=None,freqs=None,plot=False,return_pos = False,mode='v7',up_sample_factor=10,deriv_mode = 'time'):  
    '''
